...
function Flatpickr(element, config) {
    ...
    function isEnabled(dateToCheck) {
        ...
        for (var i = 0; i < array.length; i++) {
            ...
            if (d instanceof Function && d(dateToCheck)) // disabled by function
                return bool; else if ((d instanceof Date || typeof d === "string") && parseDate(d, true)
                    .getTime() === dateToCheck.getTime())
    ...
    function parseConfig() {
        ...
        Object.keys(self.element.dataset)
              .forEach(function (k) {
        ...
        Object.keys(Flatpickr.defaultConfig)
              .forEach(function (k) {
    ...
    function setupFormats() {
        self.formats = {
            ...
            y: function y(date) {
                return String(self.formats.Y(date))
                    .substring(2);
            }
        };
    }
