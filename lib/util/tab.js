...
(function (a, b) {
	...
	var tab = {
		...
		afterRender : function () {
			...
			s = this;
			s.$el = $('.dt-content');
			d = this.$contEl = s.$el.find(".dtct-container");
			e = d.parent();
			f = this.$el.find(".dtct-ul");
			a.scrollTo(0, 0);
		...
		initEvent   : function () {
			this.$el.find(".dtct-ul li").eq(0).trigger("click");
		},
